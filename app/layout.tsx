    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "ได้ครับ แพ็คเกจ Business ขึ้นไปสามารถเชื่อมต่อกับ Delivery Apps ยอดนิยมได้ทั้งหมด รวมถึง LINE SHOPPING ด้วย ออเดอร์จะเข้าระบบอัตโนมัติ ไม่ต้องกรอกซ้ำ",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "คุณสามารถตั้งสูตรอาหาร (Recipe) ได้ว่าเมนูนี้ใช้วัตถุดิบอะไรบ้าง เมื่อขายออกไป ระบบจะตัดสต็อกวัตถุดิบให้อัตโนมัติ พร้อมแจ้งเตือนเมื่อของใกล้หมด ไม่ต้องมานั่งนับสต็อกเองอีกต่อไป",
          },
        },
      ],
    },
